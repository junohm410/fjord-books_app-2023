...
ActiveRecord::Schema[7.0].define(version: 2023_09_03_051245) do
  ...
  create_table "report_mention_relationships", force: :cascade do |t|
  ...
  add_foreign_key "report_mention_relationships", "reports", column: "mentioned_report_id"
  add_foreign_key "report_mention_relationships", "reports", column: "mentioning_report_id"
